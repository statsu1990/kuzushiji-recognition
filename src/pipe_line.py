...
class CenternetPipeline_19091802Ver3_test():
    """
    image preprocessing: linear gamma correction, ben's processing(base=255)
    """
    def __init__(self, iou_thresh=None, score_thresh=None):
    ...
    def __config(self, iou_thresh=None, score_thresh=None):
        ...
        self.MODEL_DIR = os.path.join('.', 'result', 'CenternetPipeline_19091802_ver3_test', 'centernet')
        self.MODEL_FILE = os.path.join(self.MODEL_DIR, 'trained_model.h5')
        return
...
class CropedCenternetPipeline_19100201Ver3_test():
    """
    for croped image.
    image preprocessing: linear gamma correction, ben's processing(base=128)
    data augmentation: shift, random erasing
    ...
    def __config(self, iou_thresh=None, score_thresh=None):
        ...
        self.MODEL_DIR = os.path.join('.', 'result', 'CropedCenternetPipeline_19100201_ver3_test', 'centernet')
        self.MODEL_FILE = os.path.join(self.MODEL_DIR, 'trained_model.h5')
...
class ResNetPipeline_191002AspectVer9_test():
    """
    image preprocessing: gausiann filter -> gamma correction -> ben's preprocessing -> gaussian filter -> median filter
    random erasing
    """
    ...
    def __config(self):
        ...
        self.MODEL_DIR = os.path.join('.', 'result_recog', 'test191002_aspect_ver9_test', 'my_resnet')
        self.MODEL_FILE = os.path.join(self.MODEL_DIR, 'trained_model.h5')
...
class RecognitionPipeline_101302_test():
    def __init__(self):
        return
